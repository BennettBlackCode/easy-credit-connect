      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {plans.map((plan) => (
            <div
              key={plan.id}
              className={`pricing-card relative rounded-3xl p-8 bg-[#0A0A0A] border border-transparent transition-all duration-500 ${
                ...
                <div className="mb-8">
                  {plan.price !== null ? (
                    <div className="flex items-baseline">
                      ...
                      <span className="ml-2 text-gray-400">monthly</span>
                    </div>
                  ) : (
