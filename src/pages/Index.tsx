  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#030303]">
      ...
      <div className="relative">
        ...
        <div className="relative pt-24 sm:pt-32 lg:pt-40 pb-12 sm:pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <div className="text-center space-y-6 sm:space-y-8 mb-12 sm:mb-16">
              <div className="inline-block">
                <span className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-primary/10 text-primary border border-primary/20 mb-6 sm:mb-8">
                  Launching soon - Join the waitlist
                </span>
              </div>
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight mb-6 sm:mb-8 leading-[1.1]">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-400 max-w-2xl mx-auto leading-relaxed px-4">
                The most advanced AI-powered SEO automation platform. Transform your workflow with intelligent optimization.
              </p>
              <div className="flex flex-col sm:flex-row justify-center gap-4 px-4">
                <Link
                  to="/signup"
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-base font-medium rounded-2xl text-black bg-primary hover:bg-primary/90 transition-all duration-200 shadow-[0_0_30px_rgba(46,213,115,0.4)]"
                >
                  Get Early Access
                ...
                <a
                  href="#demo"
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-base font-medium rounded-2xl text-white bg-white/5 hover:bg-white/10 transition-all duration-200 border border-white/10"
                >
                  Watch Demo
                </a>
              </div>
            ...
            <div className="flex flex-col overflow-hidden -mt-12 sm:-mt-20">
              <ContainerScroll
                titleComponent={
                  <div className="h-4" />
                }
                ...
                <div className="relative w-full h-full rounded-2xl overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm">
                    <div className="text-center px-4">
                      <p className="text-white/90 text-lg sm:text-xl font-medium mb-4">Demo Video Coming Soon</p>
            ...
            {/* Stats Section */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 max-w-4xl mx-auto mt-16 sm:mt-24 px-4">
              {[
      ...
      {/* Features Section */}
      <div className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group p-6 sm:p-8 rounded-2xl transition-all duration-300 hover:scale-[1.02] bg-gradient-to-br from-white/[0.05] to-transparent border border-white/[0.05] backdrop-blur-sm"
              >
